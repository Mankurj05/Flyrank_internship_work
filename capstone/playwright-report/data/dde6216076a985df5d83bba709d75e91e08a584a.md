...
- Name: primary-flow.spec.ts >> Weather Assistant Primary Flow >> send button is disabled when input is empty
- Location: e2e\primary-flow.spec.ts:72:7
...
Locator: getByRole('button', { name: 'Send message' })
Expected: disabled
Timeout: 5000ms
