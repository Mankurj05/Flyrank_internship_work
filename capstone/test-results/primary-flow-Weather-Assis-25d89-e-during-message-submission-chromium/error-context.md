...
- Name: primary-flow.spec.ts >> Weather Assistant Primary Flow >> shows loading state during message submission
- Location: e2e\primary-flow.spec.ts:88:7
...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - contentinfo [ref=e20]:
      - generic [ref=e21]:
        - generic [ref=e22]:
          - textbox "Ask about the weather..." [active] [ref=e23]: Weather in London
          - button [ref=e24]
