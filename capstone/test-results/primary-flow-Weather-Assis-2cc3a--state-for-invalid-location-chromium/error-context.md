...
- Name: primary-flow.spec.ts >> Weather Assistant Primary Flow >> shows error state for invalid location
- Location: e2e\primary-flow.spec.ts:52:7
...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - contentinfo [ref=e20]:
      - generic [ref=e21]:
        - generic [ref=e22]:
          - textbox "Ask about the weather..." [active] [ref=e23]: What is the weather in error city?
          - button [ref=e24]
